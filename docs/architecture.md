...
- Debug overlay now also renders detected object boxes and labels (`type · objectId`) through the same normalized-page surface transform path as Border / Refined Border / Geometry overlays.
